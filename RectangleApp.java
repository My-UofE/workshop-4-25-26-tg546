...
public class RectangleApp {
	...
	public static void main( String[] args ) {
		...
		System.out.println("Rect 1: Width: "+myRect1.getWidth()+", Height: "+myRect1.getHeight());
		System.out.println("Rect2: Width: "+myRect2.getWidth()+", Height: "+myRect2.getHeight());
		System.out.println("Rect 3: Width: "+myRect3.getWidth()+", Height: "+myRect3.getHeight());
